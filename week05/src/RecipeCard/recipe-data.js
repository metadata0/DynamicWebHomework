...
//disable built-in typescript (go to extension, type @typescript to fix the error messages)
// "||" means exact type, just to help to add another layer of security
export type RecipeProps = {|
  ...
  //the function of the type object is to make sure that the data pieces matches the exact same format
|}
