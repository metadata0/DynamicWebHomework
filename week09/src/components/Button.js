...
Button.propTypes = {
    checkVariationValue: (primary, secondary, success, warning, danger) => {
        ...
        if (count > 1) {
            return new Error(
                ' only primary, secondary, success, warning and danger can be returned'
            )
        }
...
export default function Button({
        ...
        const classes = twMerge(
            cx(otherProps.className, 'flex items-center px-8 py-3 border', {
                ...
                'border-gray-900 background-gray-800 text-white': secondary,
                ...
                'text-orange-400': warning && outline,
